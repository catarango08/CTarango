        ...
        <div className="p-5 space-y-6">
          ...
          <section>
            ...
            <div className="space-y-3">
              ...
              <label className="flex items-center gap-3">
                <span className="text-sm text-slate-600 w-32 flex-shrink-0">Mileage Rate ($/mi)</span>
                <input
                  type="number"
                  min={0}
                  step={0.01}
                  value={draft.mileageRate}
                  onChange={e => setDraft(d => ({ ...d, mileageRate: parseFloat(e.target.value) || 0 }))}
                  className="flex-1 px-3 py-2 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </label>
              <p className="text-xs text-slate-400 ml-[136px]">IRS 2024 standard rate: $0.67/mile</p>
            </div>
          </section>
